...
// Type: Qbus.Communication.Protocol.Modules.Interval
...
namespace Qbus.Communication.Protocol.Modules
{
  public class Interval : Module
  {
    ...
    {
      return m.GetType() == typeof (Interval) && (int) m.Address == (int) this.Address && ((int) m.Subaddress == (int) this.Subaddress && m.Controller == this.Controller);
    }

    public override bool EqualState(Module m)
    {
      if (m.GetType() != typeof (Interval))
        return false;
      bool? status1 = ((Interval) m).Status;

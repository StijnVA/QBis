...
// Type: Qbus.Communication.Protocol.Modules.Toggle
...
namespace Qbus.Communication.Protocol.Modules
{
  public class Toggle : Module
  {
    ...
    {
      return m.GetType() == typeof (Toggle) && (int) m.Address == (int) this.Address && ((int) m.Subaddress == (int) this.Subaddress && m.Controller == this.Controller);
    }

    public override bool EqualState(Module m)
    {
      if (m.GetType() != typeof (Toggle))
        return false;
      bool? status1 = ((Toggle) m).Status;

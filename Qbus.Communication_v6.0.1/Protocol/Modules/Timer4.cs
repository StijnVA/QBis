...
// Type: Qbus.Communication.Protocol.Modules.Timer4
...
namespace Qbus.Communication.Protocol.Modules
{
  public class Timer4 : Module
  {
    ...
    {
      return m.GetType() == typeof (Timer4) && (int) m.Address == (int) this.Address && ((int) m.Subaddress == (int) this.Subaddress && m.Controller == this.Controller);
    }

    public override bool EqualState(Module m)
    {
      if (m.GetType() != typeof (Timer4))
        return false;
      bool? status1 = ((Timer4) m).Status;

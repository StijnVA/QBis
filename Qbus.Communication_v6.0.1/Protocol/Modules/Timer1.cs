...
// Type: Qbus.Communication.Protocol.Modules.Timer1
  ...
  public class Timer1 : Module
  {
    public bool? Status
    {
      get
      {
        ...
        if (((int) nullable2.GetValueOrDefault() <= 0 ? 0 : (nullable2.HasValue ? 1 : 0)) != 0)
    ...
    {
      return m.GetType() == typeof (Timer1) && (int) m.Address == (int) this.Address && ((int) m.Subaddress == (int) this.Subaddress && m.Controller == this.Controller);
    }

    public override bool EqualState(Module m)
    {
      if (m.GetType() != typeof (Timer1))
        return false;
      bool? status1 = ((Timer1) m).Status;

...
// Type: Qbus.Communication.Protocol.Modules.Timer5
  ...
  public class Timer5 : Module
  {
    public bool? Status
    {
      get
      {
        ...
        if (((int) nullable2.GetValueOrDefault() != 0 ? 1 : (!nullable2.HasValue ? 1 : 0)) != 0)
    ...
    {
      return m.GetType() == typeof (Timer5) && (int) m.Address == (int) this.Address && ((int) m.Subaddress == (int) this.Subaddress && m.Controller == this.Controller);
    }

    public override bool EqualState(Module m)
    {
      if (m.GetType() != typeof (Timer5))
        return false;
      bool? status1 = ((Timer5) m).Status;
